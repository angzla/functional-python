# Functional Python [![](https://github.com/angzla/functional-python/workflows/tests/badge.svg)](https://github.com/angzla/functional-python/actions?query=workflow%3Atests)
